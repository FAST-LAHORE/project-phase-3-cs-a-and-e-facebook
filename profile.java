...
public class profile extends javax.swing.JFrame {
    ...
    public void initheader(){
        ...
        temp=a.returnheader(userid);
        ImageIcon icon = new ImageIcon(temp.get(0)); 
       
         ImageIcon dp = new ImageIcon(temp.get(1)); 
    ...
    public void loadallposts(){
        post ab = new post();
        List<post> alldata = new ArrayList<post>();
        alldata= ab.returallpost(userid);
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("What's in your mind?");
